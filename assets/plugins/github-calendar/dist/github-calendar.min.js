    ...
    return function o(s, u, i) {
        ...
        1: [function(e, t, r) {
            ...
            t.exports = function(b, e, m) {
                b = y(b), (m = m || {}).summary_text = m.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/sats17' + e + '" target="blank">@' + e + "</a>", m.cache = 1e3 * (m.cache || 86400), !1 === m.global_stats && (b.style.minHeight = "175px");
                var r = {
                ...
                return function g() {
                    return m.getCalendar(e).then(function(e) {
                        ...
                        t.innerHTML = e;
                        var r, u, n = t.querySelector(".js-yearly-contributions");
                        if (y(".position-relative h2", n).remove(), n.querySelector("include-fragment")) setTimeout(g, 500);
                        else {
                            if (!0 === m.responsive) {
                            ...
                            b.innerHTML = n.innerHTML, !0 === m.tooltips && (r = b, (u = document.createElement("div")).classList.add("day-tooltip"), r.appendChild(u), r.querySelectorAll("rect.day").forEach(function(e) {
                                e.addEventListener("mouseenter", function(e) {
                                    ...
                                    u.innerHTML = "<strong>" + t + "</strong> on " + n, u.classList.add("is-visible");
